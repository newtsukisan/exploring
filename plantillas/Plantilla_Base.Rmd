...
corte.precios      <- c(0,3000,4000,20000)
corte.preciomedio  <- c(0,200000,350000,500000,6000000)
...
levels.metros      <- c('hasta 45 metros', 'entre 45 y 120','entre 120 y 300','mas de 300')
...
# Ahora calculamos algunos factores para presentar algunos dibujos
 ...
 data$factor.preciometro  <- cut(as.numeric(data$preciometro), corte.precios )
 data$factor.price        <- cut(as.numeric(data$price),       corte.preciomedio)
 ...
 levels(data$factor.preciometro) <- corte.preciomedio
 # valores descriptivos para la superficie.
 levels(data$factor.size) <- corte.metros
