...
file.xlsx <- "resultados/excel/CalleNicaragua19-18-09-2014.xls"


# Operations --------------------------------------------------------------
# Zona de salamanca. Cargamos los datos desde idealista.
idealista <- getDataFromIdealista(40.457828, -3.670684, 201, 
...
comparativos <- subset (idealista, propertyType=='piso') # Por tipo
comparativos <- subset (comparativos, size > 60)
